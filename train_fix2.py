...
modelPath = r"D:\@linux_share\cpk_gender128\epoth_0.9809688581314879_239_model.pth"
...
trainset=dset.ImageFolder(r'I:\datasets\attribute\Orientation\train',transform=transform_train)
print(trainset[0][0])
valset  =dset.ImageFolder(r'I:\datasets\attribute\Orientation\val',transform=transform_val)
print(len(valset))
...
def val(epoch):
	...
	exModelName = r"H:/daTUtest/zxc_st/@cpk_model/MODEL128/Oriten/" +str(accuracy)+"_"+"epoth_"+ str(epoch) + "_model" + ".pth"
	# torch.save(model.state_dict(),exModelName)
	torch.save(model.state_dict(), exModelName)

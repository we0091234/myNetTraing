...
model.load_state_dict(torch.load(r'D:\@linux_share\cpk_sleeve3\epoth_0.9343163538873994_epoth_463_model.pth'))
...
torch.save({'cfg': cfg, 'state_dict': newmodel.state_dict()}, os.path.join(saveFolder, 'pruned_fix_Sleeve0.5.pth.tar'))

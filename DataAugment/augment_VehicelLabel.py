...
NUM_IMG=100
def main():
    path=r"/home/lxk/ZHP/data/Vehicle/VehicleData2/ve_side"
    # path=r"/home/lxk/ZHP/data/ReIDData_Aug/YT3"  #使用绝对路径
    save_path=r'/home/data_ssd/ZHP/VehicleAug/ve_side'
    flag=0
    width = 128
    height =128
    for roof, d, filelist in os.walk(path):
        if not d and  filelist:
            ...
            if num>0 and num <NUM_IMG:
                ...
                p1.random_erasing(probability=0.5, rectangle_area=0.4)

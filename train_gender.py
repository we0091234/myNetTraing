...
def val(epoch):
	...
	exModelName = r"H:/@pedestrain_attribute2020_1/handBag/model/" +str(accuracy)+"_"+"epoth_"+ str(epoch) + "_model" + ".pth.tar"
	# torch.save(model.state_dict(),exModelName)
...
if __name__=='__main__':
	...
	trainset=dset.ImageFolder(r'H:\@pedestrain_attribute2020_1\handBag\train',transform=transform_train,loader=cv_imread)
	print(trainset[0][0])
	valset  =dset.ImageFolder(r'M:\GetSmallPIc2\5',transform=transform_val,loader=cv_imread)
	print(len(valset))
